      ...
      <div className="container px-4">
        <div className="grid gap-12 lg:gap-16">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tight text-center text-white">Welcome to Our World</h1>
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl font-semibold tracking-tight  text-white">Our Achievements</h2>
              <li className="flex items-start space-x-2">
                <span className="text-lg text-[#A8DDDA]  space-x-2">Unmatched customer satisfaction</span>
              </li>
              <li className="flex items-start space-x-2">
            ...
            <div className="mx-auto my-20 grid grid-cols-4 lg:grid-cols-4 gap-8 max-w-screen-lg">
                {
                  Team.map((user)=>{
                    return(
                      <div key={user.id} className='  w-full rounded-full flex'>
                        <img
                          src={user.src}
                          width={120}
                          height={120}
